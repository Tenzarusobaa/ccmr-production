// Updated AddCase.js with student ID autocomplete
import React, { useEffect, useState } from "react";
import "./AddCase.css";

const AddCase = ({ isOpen, onClose, onRecordAdded }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Notify parent component that a new record was added
        if (onRecordAdded) {
          onRecordAdded();
        }
        ...
        alert("Error adding case record: " + result.message);
      }
    } catch (error) {
      console.error("Error:", error);
      alert("An error occurred while adding the case record.");
    } finally {
